...
namespace client
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            {"Сотрудник", "SELECT Сотрудник.Код, Сотрудник.Название, Сотрудник.Фамилия, Должность.Название, Подразделение.Название " +
            ...
            {"Кабинет","SELECT Кабинет.Код, Подразделение.Название, Кабинет.Название, Кабинет.Удалить FROM Кабинет LEFT JOIN Подразделение ON Подразделение.Код = Кабинет.ПодразделениеНазвание ORDER BY Кабинет.Код;" }
        };
        public MainWindow()
        {
            InitializeComponent();
